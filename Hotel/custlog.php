    ...
    <div class="cust">
		<form action="custlog1.php" method="POST">
        <div class="log">
        <h2>Enter Email:</h2>
        <input class="inp" type="text" name="txt1"><br>
        <h2>Enter Password</h2>
        <input class="inp" type="password" name="pwd"><br><br><br>
        <input id="sub" type="submit" name="Submit"><br><br>
        <b>Haven't Register Yet?</b><br><br><a class="reg" href="contactdetails.php">"CLICK HERE"</a>
        <div>
</form>
        </center>
</div>
